...
export const JOB_ROLES: JobRole[] = [
  {
    ...
    description: "Analyze data, build ML models, and communicate insights.",
  },
  {
    ...
    description: "Productionize ML models and build scalable pipelines.",
  },
  {
    title: "Data Analyst",
    tags: [
    ...
    description: "Transform data into dashboards and reports.",
  },
  {
    title: "NLP Engineer",
    tags: [
    ...
    description: "Build language models and text-processing systems.",
  },
  {
    title: "Computer Vision Engineer",
    tags: ["computer vision", "opencv", "pytorch", "tensorflow", "python"],
    description: "Design and deploy image/video understanding models.",
  },
  {
  ...
  },
  {
    ...
    description: "Build and maintain server-side services and APIs.",
  },
  {
    title: "Data Engineer",
    tags: [
...
export function suggestJobs(
  ...
  const scored = JOB_ROLES.map((role) => {
    ...
    const matched = normalize(role.tags).filter((t) =>
      candidateSkills.includes(t),
    );
    const missing = normalize(role.tags).filter(
      (t) => !candidateSkills.includes(t),
    );
  ...
  scored.sort(
    (a, b) => b.score + boost(b.role.title) - (a.score + boost(a.role.title)),
  );
...
function buildUniverse(candidate: string[]): string[] {
  ...
  for (const role of JOB_ROLES)
    for (const t of role.tags) set.add(t.toLowerCase());
